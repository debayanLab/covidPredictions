...
#print(india_deaths.head(10))
#print(india_total.head(10))
#print(india_combined)

#india_combined.to_csv("combined-india-covid-19.csv")

#print(india_combined.tail(10))
...
#print(india_combined.iloc[84,4])



#india_combined.plot(kind='line', x="Date", y="Total confirmed deaths due to COVID-19 (deaths)")
